...
public class Base64 {
	 ...
	 */
	public static byte[] decodeStandard(String inStr)
		throws IllegalBase64Exception {
	...
	private static byte[] decode(String inStr, byte[] reverseAlphabet)
		...
		try {
			...
			for (i = 0; i < wholeInLen;) {
				...
				if ((orValue & 0x80) != 0) throw new IllegalBase64Exception(
			...
			return out;
		} catch (ArrayIndexOutOfBoundsException e) { // looking up reverseAlphabet. // Illegal characters can cause an ArrayIndexOutOfBoundsException when
