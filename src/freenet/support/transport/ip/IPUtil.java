...
public class IPUtil {
	...
	public static boolean isValidAddress(InetAddress i, boolean includeLocalAddressesInNoderefs) {
		if (i.isAnyLocalAddress()) {
			...
			return ipAddressBytes.length != 4 || ipAddressBytes[0] != 0;  // First octet of IPv4 address cannot be zero as 0.0.0.0/8 has been reserved since at least RFC790 (also, Java throws an IOException when they're used)
		}
	}
