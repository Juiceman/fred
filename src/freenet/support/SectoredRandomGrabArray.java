 ...
 * Again, not persistent; this is reconstructed on restart.
 *
 ...
 *
 * <p>A lot of this is over-complicated and over-expensive because of db4o. A lot of it is O(n).
 * This is all kept in RAM now so we can change it at will, plus there is only one object queued per
 * splitfile now, so memory pressure is much less of an issue. FIXME Simplify and improve
 * performance!
 */
