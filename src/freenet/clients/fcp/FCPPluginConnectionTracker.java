...
final class FCPPluginConnectionTracker extends NativeThread {
	 ...
	 *
	 * @param connectionID The value of {@link FCPPluginConnection#getID()} of a client connection which has already
	 ...
	 * @throws IOException If there has been no connection with the given ID or if the client has disconnected.
	 */
