...
public interface FCPPluginConnection {
	 ...
	 * @param message   You <b>must not</b> send the same message twice: This can break {@link #sendSynchronous(
	 *SendDirection, FCPPluginMessage, long)}.<br>
	 ...
	 *                           this.<br><br>
	 * @param message            <b>Must be</b> constructed using {@link FCPPluginMessage#construct(SimpleFieldSet,
	 ...
	 * @param timeoutNanoSeconds The function will wait for a reply to arrive for this amount of time.<br>
	 ...
	 * @return The reply {@link FCPPluginMessage} which the remote partner sent to your message.<br><br>
	 *
	 ...
	 * @throws IOException          If the given timeout expired before a reply was received <b>or</b> if the connection has
	 *                              been closed before even sending the message.<br>
	 *                              This FCPPluginConnection <b>should be</b> considered as dead once this happens, you
	 *                              should then discard it and obtain a fresh one.
	 * @throws InterruptedException If another thread called {@link Thread#interrupt()} upon the thread which you used to
