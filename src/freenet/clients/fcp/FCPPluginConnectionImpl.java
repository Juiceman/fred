...
final class FCPPluginConnectionImpl implements FCPPluginConnection {
	 ...
	 *
	 * @return True if there was a thread waiting for the message and the message was dispatched to it.
	...
	private abstract static class DefaultSendDirectionAdapter implements FCPPluginConnection {
		...
		@Override
		public FCPPluginMessage sendSynchronous(FCPPluginMessage message,
		...
		@Override
		public void send(SendDirection direction, FCPPluginMessage message)
				throws IOException {
			getConnection().send(direction, message);
		}

		@Override
		public FCPPluginMessage sendSynchronous(SendDirection direction,
	...
	/**
	 * @throws NoSendDirectionSpecifiedException Is always thrown since this function is only implemented for FCPPluginConnectionImpl
