...
final class FCPPluginConnectionImpl implements FCPPluginConnection {
   ...
   * NodeStarter#createTestNode(freenet.node.NodeStarter.TestNodeParameters)} instead of this
   * constructor:<br>
        ...
        new PrioRunnable() {
          ...
          public void run() {
            ...
            try {
              ...
              String errorMessage =
                  "FredPluginFCPMessageHandler threw."
              ...
              if (!message.isReplyMessage()) {
                ...
                reply =
                    FCPPluginMessage.constructReplyMessage(
                        ...
                        false,
                        "InternalError",
                        errorMessage + "; Throwable = " + e.toString());
              }
            }
            ...
            if (reply != null) {
              ...
              if (!message.isReplyMessage()) {
                ...
                Logger.warning(
                    messageHandler,
                    "Fred did not receive a reply from the message "
            ...
            try {
              ...
              Logger.warning(
                  messageHandler,
                  "Sending reply from FredPluginFCPMessageHandler"
