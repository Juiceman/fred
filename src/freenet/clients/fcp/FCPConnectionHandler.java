...
public class FCPConnectionHandler implements Closeable {
	...
	/**
	 * @return The {@link FCPPluginConnection} for the given serverPluginName (see
	 ...
	 * @return
	 * @throws IllegalArgumentException FIXME: Maybe we need to enqueue a PS job to delete the created file after something like ... 5 mins ?
	 */
	...
	public void unsubscribeUSK(String identifier) throws MessageInvalidException {
		...
		synchronized (this) {
			...
			if (sub == null)
				throw new MessageInvalidException(ProtocolErrorMessage.NO_SUCH_IDENTIFIER, "No such identifier unsubscribing", identifier, false);
		}
		sub.unsubscribe();
	}
