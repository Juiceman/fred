...
public class GetFailedMessage extends FCPMessage implements Serializable {
   ...
   *
   * @param verbose If true, include fields which derive directly from static stuff on
   *     InsertException (and therefore can be omitted if talking to self or another node).
   */
