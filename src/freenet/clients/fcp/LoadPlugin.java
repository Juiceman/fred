...
public class LoadPlugin extends FCPMessage {
  ...
  public LoadPlugin(SimpleFieldSet fs) throws MessageInvalidException {
    ...
    if (pluginURL == null)
      throw new MessageInvalidException(
          ProtocolErrorMessage.MISSING_FIELD, "Must contain a PluginURL field", identifier, false);
    ...
    if (!node.pluginManager.isEnabled()) {
      handler.send(
          new ProtocolErrorMessage(
              ProtocolErrorMessage.PLUGINS_DISABLED, false, "Plugins disabled", identifier, false));
      return;
    }
