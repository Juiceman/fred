...
public class N2NTMToadlet extends Toadlet {
	...
	public void handleMethodGET(URI uri, HTTPRequest request, ToadletContext ctx) throws ToadletContextClosedException, IOException, RedirectException {
		...
		if (request.isParameterSet("peernode_hashcode")) {
			...
			if (peernode_name == null) {
				contentNode.addChild(createPeerInfobox("infobox-error", l10n("peerNotFoundTitle"), l10n("peerNotFoundWithHash", "hash", input_hashcode_string)));
						...
						try {
							...
							if (!file.getFilename().isEmpty()) {
								...
								if (size > 0) {
									long limit = maxSize();
									if (size > limit) {
										peerTableInfobox.addChild("#", l10n("tooLarge", new String[] { "attempt", "limit" }, new String[] { SizeUtil.formatSize(size, true), SizeUtil.formatSize(limit, true) }));
	...
	public static void createN2NTMSendForm(HTMLNode pageNode, boolean advancedMode, HTMLNode contentNode, ToadletContext ctx, HashMap<String, String> peers) throws ToadletContextClosedException, IOException {
		...
		messageForm.addChild("input", new String[] { "type", "name", "value" }, new String[] { "submit", "send", l10n("sendMessageShort") });
	}
