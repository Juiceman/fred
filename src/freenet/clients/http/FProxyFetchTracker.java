...
public class FProxyFetchTracker implements Runnable {
  ...
  /**
   * Gets an FProxyFetchInProgress identified by the URI and the maxsize. If no such FetchInProgress
  ...
  public void run() {
    ...
    if (needRequeue) context.ticker.queueTimedJob(this, FProxyFetchInProgress.LIFETIME);
  }
