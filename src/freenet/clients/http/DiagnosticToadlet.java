...
public class DiagnosticToadlet extends Toadlet {
  ...
  public void handleMethodGET(URI uri, HTTPRequest request, ToadletContext ctx)
    ...
    synchronized (this) {
      ...
      if (total[0] == 0 || total[1] == 0) textBuilder.append("bandwidth error\n");
      else {
  ...
  private StringBuilder threadsStats() {
    ...
    ThreadDiagnostics threadDiagnostics = node.getNodeDiagnostics().getThreadDiagnostics();
