...
public class BookmarkEditorToadlet extends Toadlet {
  ...
  private void addCategoryToList(
    ...
    for (int i = 0; i < items.size(); i++) {
      ...
      actions
          .addChild("a", "href", "?action=edit&bookmark=" + itemPath)
          .addChild(
              "img",
      ...
      actions
          .addChild("a", "href", "?action=del&bookmark=" + itemPath)
          .addChild(
              "img",
              new String[] {"src", "alt", "title"},
      ...
      if (cutedPath == null)
        actions
            .addChild("a", "href", "?action=cut&bookmark=" + itemPath)
            .addChild(
                "img",
                new String[] {"src", "alt", "title"},
      ...
      if (i != 0)
        actions
            .addChild("a", "href", "?action=up&bookmark=" + itemPath)
            .addChild(
                "img",
                new String[] {"src", "alt", "title"},
      ...
      if (i != items.size() - 1)
        actions
            .addChild("a", "href", "?action=down&bookmark=" + itemPath)
            .addChild(
                "img",
                new String[] {"src", "alt", "title"},
      ...
      if (hasFriends)
        actions.addChild(
            "a",
            "href",
            "?action=share&bookmark=" + itemPath,
    ...
    for (int i = 0; i < cats.size(); i++) {
      ...
      actions
          .addChild("a", "href", "?action=edit&bookmark=" + catPathEncoded)
          .addChild(
              "img",
              new String[] {"src", "alt", "title"},
              new String[] {"/static/icon/edit.png", edit, edit});
      ...
      actions
          .addChild("a", "href", "?action=del&bookmark=" + catPathEncoded)
          .addChild(
              "img",
              new String[] {"src", "alt", "title"},
              new String[] {"/static/icon/delete.png", delete, delete});
      ...
      actions
          .addChild("a", "href", "?action=addItem&bookmark=" + catPathEncoded)
          .addChild(
              "img",
              new String[] {"src", "alt", "title"},
      ...
      actions
          .addChild("a", "href", "?action=addCat&bookmark=" + catPathEncoded)
          .addChild(
              "img",
              new String[] {"src", "alt", "title"},
      ...
      if (cutedPath == null)
        actions
            .addChild("a", "href", "?action=cut&bookmark=" + catPathEncoded)
            .addChild(
                "img",
                new String[] {"src", "alt", "title"},
                new String[] {"/static/icon/cut.png", cut, cut});
      ...
      if (i != 0)
        actions
            .addChild("a", "href", "?action=up&bookmark=" + catPathEncoded)
            .addChild(
                "img",
                new String[] {"src", "alt", "title"},
                new String[] {"/static/icon/go-up.png", moveUp, moveUp});
      ...
      if (i != cats.size() - 1)
        actions
            .addChild("a", "href", "?action=down&bookmark=" + catPathEncoded)
            .addChild(
                "img",
                new String[] {"src", "alt", "title"},
                new String[] {"/static/icon/go-down.png", moveDown, moveDown});
      ...
      if (cutedPath != null
        ...
        actions
            .addChild("a", "href", "?action=paste&bookmark=" + catPathEncoded)
            .addChild(
                "img",
                new String[] {"src", "alt", "title"},
      ...
      if (cats.get(i).size() != 0)
        addCategoryToList(
            cats.get(i), catPath, list.addChild("li").addChild("ul"), bookmarkManager);
    }
  }
  ...
  private HTMLNode getBookmarksList(BookmarkManager bookmarkManager) {
    ...
    actions
        .addChild("a", "href", "?action=addItem&bookmark=/")
        .addChild(
            "img",
            new String[] {"src", "alt", "title"},
            new String[] {"/static/icon/bookmark-new.png", addBookmark, addBookmark});
    actions
        .addChild("a", "href", "?action=addCat&bookmark=/")
        .addChild(
            "img",
            new String[] {"src", "alt", "title"},
            new String[] {"/static/icon/folder-new.png", addCategory, addCategory});
    ...
    if (cutedPath != null && !"/".equals(bookmarkManager.parentPath(cutedPath)))
      actions
          .addChild("a", "href", "?action=paste&bookmark=/")
          .addChild(
              "img",
              new String[] {"src", "alt", "title"},
              new String[] {"/static/icon/paste.png", paste, paste});
  ...
  public void handleMethodGET(URI uri, HTTPRequest req, ToadletContext ctx)
    ...
    if (req.getParam("action").length() > 0 && originalBookmark.length() > 0) {
      ...
      try {
        ...
        pageMaker
            .getInfobox("infobox-error", error, content, "bookmark-url-decode-error", false)
      ...
      if (bookmarkPath.endsWith("/")) bookmark = bookmarkManager.getCategoryByPath(bookmarkPath);
      else bookmark = bookmarkManager.getItemByPath(bookmarkPath);

      if (bookmark == null) {
        pageMaker
            .getInfobox("infobox-error", error, content, "bookmark-does-not-exist", false)
            .addChild(
                "#",
                NodeL10n.getBase()
                    .getString(
      ...
      } else if ("cut".equals(action)) cutedPath = bookmarkPath;
        ...
        else header = NodeL10n.getBase().getString("BookmarkEditorToadlet.addNewCategory");
        ...
        form.addChild(
            "input",
            new String[] {"type", "id", "name", "size", "value"},
        ...
        if (("edit".equals(action) && bookmark instanceof BookmarkItem)
          ...
          if (core.node.getDarknetConnections().length > 0
            ...
            if (core.node.isFProxyJavascriptEnabled()) {
              ...
              headerRow.addChild(
                  "th", NodeL10n.getBase().getString("QueueToadlet.recommendToFriends"));
            } else {
              peerTable
                  .addChild("tr")
                  .addChild(
      ...
      } else if ("up".equals(action)) bookmarkManager.moveBookmarkUp(bookmarkPath, true);
      else if ("down".equals(action)) bookmarkManager.moveBookmarkDown(bookmarkPath, true);
    }
    ...
    if (cutedPath != null) {
      ...
      cancelForm.addChild(
          ...
          new String[] {"type", "name", "value"},
          new String[] {
            "submit", "cancelCut", NodeL10n.getBase().getString("BookmarkEditorToadlet.cancelCut")
          });
      cancelForm.addChild(
          "input",
          new String[] {"type", "name", "value"},
  ...
  public void handleMethodPOST(URI uri, HTTPRequest req, ToadletContext ctx)
    ...
    try {
      ...
      if (req.isPartSet("confirmdelete")) {
      ...
      } else if (req.isPartSet("cancelCut")) cutedPath = null;
      else if ("edit".equals(action) || "addItem".equals(action) || "addCat".equals(action)) {

        String name = "unnamed";
        if (req.isPartSet("name")) name = req.getPartAsStringFailsafe("name", MAX_NAME_LENGTH);
        ...
        if ("edit".equals(action)) {
          ...
          if (bookmark instanceof BookmarkItem) {
            ...
            sendBookmarkFeeds(
                req, item, req.getPartAsStringFailsafe("publicDescB", MAX_KEY_LENGTH));
          }
          bookmarkManager.storeBookmarks();
          ...
          if ("addItem".equals(action)) {
            ...
            addNameError(pageMaker, content);
          } else newBookmark = new BookmarkCategory(name);
          ...
          if (newBookmark != null) {
            ...
            pageMaker
                .getInfobox(
                    ...
                    false)
                .addChild(
                    "p", NodeL10n.getBase().getString("BookmarkEditorToadlet.addedNewBookmark"));
          }
        }
      } else if ("share".equals(action))
        sendBookmarkFeeds(
