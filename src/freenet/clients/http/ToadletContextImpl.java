...
public class ToadletContextImpl implements ToadletContext {
  ...
  /**
   * Fix key case to be conformant to HTTP expectations. Note that HTTP is case insensitive on
   * header names, but we may as well send something as close to the spec as possible in case of
   * broken clients...
   */
