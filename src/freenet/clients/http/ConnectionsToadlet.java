  ...
  protected class ComparatorByStatus implements Comparator<PeerNodeStatus> {
    ...
    protected int customCompare(
      ...
      if (sortBy.equals("address")) {
        ...
        return Version.getArbitraryBuildNumber(firstNode.getVersion(), -1)
      ...
      if (urltext.length() > 0) {
        ...
        try {
          try {
            ...
            Logger.warning(
                this, "Url cannot be used as Freenet URI, trying to fetch as URL: " + urltext);
    ...
    if (advancedModeEnabled) {
      ...
      backoffCell.addChild(
          ...
          ' '
              ...
              + '/'
              + String.valueOf(peerNodeStatus.getRoutingBackoffLength(true) / 1000));
      backoffCell.addChild(
          "#",
      ...
      backoffCell.addChild(
          ...
          ' '
              + String.valueOf(backoff / 1000)
              + '/'
              + String.valueOf(peerNodeStatus.getRoutingBackoffLength(false) / 1000));
      backoffCell.addChild(
          "#",
