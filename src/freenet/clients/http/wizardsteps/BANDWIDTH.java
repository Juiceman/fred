...
public class BANDWIDTH implements Step {
	...
	public void getStep(HTTPRequest request, PageHelper helper) {
		...
		HTMLNode bandwidthInfoboxContent = helper.getInfobox("infobox-normal",
	...
	public String postStep(HTTPRequest request)  {
		...
		/*else if (request.isPartSet("no"))*/ return
			FirstTimeWizardToadlet.WIZARD_STEP.BANDWIDTH_RATE.name();
