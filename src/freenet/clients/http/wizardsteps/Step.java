...
/**
 * Classes which implement Step are sub-Toadlets accessible only through the wizard, and are not
 * registered in FProxy.
 */
public interface Step {
   ...
   * @param helper used to get a style-conforming page content node, forms, and InfoBoxes without
   *     access to ToadletContext.
   */
