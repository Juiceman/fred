...
/**
 * A KeyBlock with a ClientKey. Can be decoded. Not a child of KeyBlock because of issues with
 * equals().
 */
public interface ClientKeyBlock {
  ...
  /**
   * This is why ClientKeyBlock isn't instanceof KeyBlock: Two ClientKeyBlock's with the same
   * content but different keys are not equals(), therefore a ClientKeyBlock and its KeyBlock have
   * to be !equals too. Hence it's really a different kind of object, so not a child.
   */
  @Override
