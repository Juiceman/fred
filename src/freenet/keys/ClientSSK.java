 ...
 * is fetched. Note that you can only use this to *REQUEST* keys, not to *INSERT* them, because it
  ...
  public Key getNodeKey(boolean cloneKey) {
    try {
      ...
      throw (AssertionError)
          new AssertionError("Have already verified and yet it fails!").initCause(e);
    }
  }
