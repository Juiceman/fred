...
/**
 * Provides the content of the ISO639-3 standard for language codes. Description of what this
 * standard is (taken from http://www.sil.org/iso639-3/default.asp):
 *
 * <p>"ISO 639-3 is a code that aims to define three-letter identifiers for all known human
 * languages. At the core of ISO 639-3 are the individual languages already accounted for in ISO
 * 639-2. The large number of living languages in the initial inventory of ISO 639-3 beyond those
 * already included in ISO 639-2 was derived primarily from Ethnologue (15th edition). Additional
 * extinct, ancient, historic, and constructed languages have been obtained from Linguist List."
 *
 * <p>Source of the code tables in here: http://www.sil.org/iso639-3/iso-639-3_20100707.tab
 *
...
public final class ISO639_3 {
  ...
  /**
   * A class which represents a language code. It was translated from the example
   * SQL-table-definition on http://www.sil.org/iso639-3/download.asp
   *
   * <p>The quoted texts on the JavaDoc of the member variables are the original comments from the
   * SQL-table-definition.
   *
   * <p>All members are final, therefore objects of this class do not need to be cloned by clients
   * of ISO639_3.
   */
  public static final class LanguageCode implements Comparable<LanguageCode> {
    ...
    /**
     * "Equivalent 639-2 identifier of the bibliographic applications code set, if there is one", 3
     * characters, may be null.
     */
    public final String part2B;

    /**
     * "Equivalent 639-2 identifier of the terminology applications code set, if there is one", 3
     * characters, may be null.
     */
    ...
    try {
      ...
      in =
          ISO639_3
              .class
              .getClassLoader()
              .getResourceAsStream("freenet/l10n/iso-639-3_20100707.tab");

      if (in == null) throw new RuntimeException("Could not open the language codes resource");
   ...
   * The list is cached for the lifetime of this ISO639_3 object, make sure not to keep the ISO639_3
   * object alive if you only use a small part of all languages.
   *
   ...
   *
   * @return Returns the map of all ISO639-3 language codes. The key in the returned list is the ID
   *     of the language code, which is the 3-letter code of ISO639-3. The given map is unmodifiable
   *     since it is used for the cache.
   */
   ...
   * @return Gets a {@link Hashtable} of language codes with the given scope and type. The key in
   *     the returned list is the ID of the language code, which is the 3-letter code of ISO639-3.
   *     The given Hashtable is free for modification.
   */
  public final Hashtable<String, LanguageCode> getLanguagesByScopeAndType(
  ...
  /**
   * @return The special symbolic language code which is supposed to be a category for multiple
   *     languages.
   */
