...
public class InsertContext implements Cloneable, Serializable {
  ...
  public static enum CompatibilityMode {
    ...
    COMPAT_1251((short) 4),
    /**
     * 1255: Second stage of even splitting, a whole bunch of segments lose one block rather than
     * the last segment losing lots of blocks. And hashes too!
     */
    COMPAT_1255((short) 5),
  ...
  public boolean equals(Object obj) {
    ...
    if (splitfileSegmentDataBlocks != other.splitfileSegmentDataBlocks) return false;
    return true;
  }
