...
public class DefaultMIMETypes {
  ...
  private static HashMap<Short, String[]> allExtensionsByMimeNumber =
  ...
  protected static synchronized void addMIMEType(
    ...
    if (outExtension != null) primaryExtensionByMimeNumber.put(t, outExtension);
  }
  ...
  public static synchronized boolean isValidExt(String expectedMimeType, String oldExt) {
    ...
    for (String extension : extensions) if (oldExt.equalsIgnoreCase(extension)) return true;
    return false;
  }
  ...
  private static Pattern MIME_TYPE =
  ...
  public static String forceExtension(String s, String expectedMimeType) {
    ...
    if (dotIdx != -1) {
      ...
      if (DefaultMIMETypes.isValidExt(expectedMimeType, oldExt)) return s;
      return s + '.' + ext;
    }
    return s + '.' + ext;
  }
