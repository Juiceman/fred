...
public class ContentFilter {
  ...
  public static void init() {
    ...
    //              new String[0], true, false, null, null, false, false, false, false, false,
    // false,
    ...
    register(
        new FilterMIMEType(
            HTML_MIME_TYPES[0],
            "html",
            Arrays.asList(HTML_MIME_TYPES)
                .subList(1, HTML_MIME_TYPES.length)
                .toArray(new String[HTML_MIME_TYPES.length - 1]),
            new String[] {"htm"},
            false,
            false /* maybe? */,
            new HTMLFilter(),
