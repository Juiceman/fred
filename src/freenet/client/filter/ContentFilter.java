...
//				false, null, null, false));
	 ...
	 * @param maybeCharset      MIME type of the referring document, as a hint, some types,
	 ...
	 * @throws IllegalStateException      If data is invalid (e.g. corrupted file) and the filter have no way to recover.
	 */
	public static FilterStatus filter(
			InputStream input,
			OutputStream output,
