...
public class NullClientCallback implements ClientGetCallback, ClientPutCallback {
	...
	public void onFailure(FetchException e, ClientGetter state) {
		if (logDEBUG) {
			Logger.debug(this, "NullClientCallback#onFailure e=" + e + ", state=" + state, e);
		}
	}
	...
	public void onFetchable(BaseClientPutter state) {
		if (logDEBUG) {
			Logger.debug(this, "NullClientCallback#onFetchable state=" + state);
		}
	}
	...
	public void onSuccess(BaseClientPutter state) {
		if (logDEBUG) {
			Logger.debug(this, "NullClientCallback#onSuccess state=" + state);
		}
	}
	...
	public void onGeneratedMetadata(Bucket metadata, BaseClientPutter state) {
		if(logDEBUG) {
			Logger.debug(this, "NullClientCallback#onGeneratedMetadata state=" + state);
		}
		metadata.free();
	}
