...
public class SplitFileInserterStorage {
	 ...
	 *
	 * @param originalData      The original data as a RandomAccessBuffer. We need to be able
	 *                          to read single blocks.
	 * @param rafFactory        A factory (persistent or not as appropriate) used to create
	 *                          the temporary RAF storing check blocks etc.
	 * @param bf                A temporary Bucket factory used for temporarily storing the
