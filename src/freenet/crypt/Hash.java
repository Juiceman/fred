...
public final class Hash {
  ...
  /**
   * Generates the hash as a NativeBigInteger of all the bytes in the buffer added with the addBytes
   * methods. The buffer is then cleared after the hash has been generated.
   *
   * @return The generated hash as a NativeBigInteger of all the bytes added since last reset.
   */
  ...
  /**
   * Generates the hash as a NativeBigInteger string of only the specified bytes. The buffer is
   * cleared before processing the input to ensure that no extra data is included. Once the hash has
   * been generated, the buffer is cleared again.
   *
   * @param input The bytes to hash
