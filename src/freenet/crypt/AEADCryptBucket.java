 ...
 * using Closer.close() on InputStream's opened on this Bucket. The MAC is only checked when the end
 * of the bucket is reached, which may be in read() or may be in close().
 *
 * @author toad
 */
