...
public class Rijndael implements BlockCipher {
  ...
  private static long benchmark(Cipher cipher, SecretKeySpec key, IvParameterSpec IV)
  ...
  /**
   * @return null if JCA is crippled (restricted to 128-bit) so we need to use this class.
   */
