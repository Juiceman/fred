...
public class PluginRespirator {
	 ...
	 * @param messageHandler An object of your plugin which implements the
	 ...
	 *
	 * @param connectionID The connection's {@link UUID} as obtained by {@link FCPPluginConnection#getID()}.
	 * @return The client connection if it is still connected.
	 * @throws IOException If there has been no client connection with the given ID or if the client has
