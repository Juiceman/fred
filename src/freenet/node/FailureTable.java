...
public class FailureTable {
  ...
  /**
   * Terminate a request if there was a DNF on the same key less than 10 minutes ago. Maximum time
  ...
  public void start() {
    offerExecutor.start(
        node.executor, "FailureTable offers executor for " + node.getDarknetPortNumber());
  }
