...
public class AbstractUserEvent extends AbstractUserAlert implements UserEvent {
	...
	public AbstractUserEvent(Type eventType, boolean userCanDismiss, String title, String text,
							 String shortText, HTMLNode htmlText, short priorityClass, boolean valid, String dismissButtonText,
