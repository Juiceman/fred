...
public abstract class UIDTag {
  ...
  public synchronized void handlingTimeout(PeerNode next) {
    if (handlingTimeouts == null) handlingTimeouts = new HashSet<PeerNode>();
  ...
  /**
   * Set a flag indicating the originator should slow down. Only used at the shouldRejectRequest
   * stage.
   */
