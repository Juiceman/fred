...
public class Base64Test {
	...
	public void testEncodeStandard() {
		...
		assertEquals(
			Base64.encodeStandard(aByteArrayToEncode),
			testSampleStandardEncoding
		);
	}
	...
	public void testDecodeStandard() throws Exception {
		String decodedString = new String(
			Base64.decodeStandard(testSampleStandardEncoding),
	...
	public void testRandom() throws IllegalBase64Exception {
		...
		for (iter = 0; iter < 1000; iter++) {
			...
			for (int i = 0; i < b.length; i++) assertEquals(
				"data mismatch: index " +
				i +
				" of " +
				b.length +
